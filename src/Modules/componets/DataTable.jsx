                ...
                <div className='card p-3'>
                    <form id='league-add-form'>
                         ...
                         <div className="mb-3">
                            ...
                            <CFormControl type="text" id="league_name" maxLength={20} placeholder="Enter Game Name" required />
                        </div> 
                        <div className="mb-3">
                            <CFormLabel ><b>Entry Fee</b></CFormLabel>
                            <CFormControl type="text" id="league_name" maxLength={20} placeholder="Enter Entry Fee" required />
                        </div> 
                        <div className="mb-3">
                            <CFormLabel ><b>Prize Ammount</b></CFormLabel>
                            <CFormControl type="text" id="league_name" maxLength={20} placeholder="Enter Prize Ammount" required />
                        </div> 
                        <div className="mb-3">
                            <CFormLabel ><b>Played</b></CFormLabel>
                            <CFormControl type="text" id="league_name" maxLength={20} placeholder="Played" required />
                        </div> 
                        ...
                        {/* <div className="mb-3">
                            <CFormLabel ><b>Track Type*</b></CFormLabel>
                            <CFormSelect id='track_type' required>
                                <option value="0">Select Track Type</option>
                                <option value="1">new_york_blitz</option>
                                <option value="2">track_2</option>

                            </CFormSelect>
                        </div>
                        <div className="mb-3">
                            <CFormLabel ><b>Level*</b></CFormLabel>
                        ...
                        {/* <div className="mb-3">
                            <CFormLabel ><b>League Availibility*</b></CFormLabel>
                            <CFormSelect id='league_availibility' required>
                                <option value="0">Select League Availibility</option>
                       ...
                       {/* <div className="row mb-3"> */}
                        ...
                        {/* <div className="row mb-3">
                            ...
                            <div className='col-4'>
                                <CFormLabel ><b>No of Laps*</b></CFormLabel>
                                <CFormControl min="1" max="3" type="number" id="no_of_laps" placeholder="no_of_laps of Players" />
                            </div>
                            {/* <div className='col-4'>
                            ...
                            {/* <div className='col-4'>
                                <CFormLabel ><b>Winning Amount</b></CFormLabel>
                                <CFormControl min="1" type="number" id="winning_amount" placeholder="winning amount of League" />
                            </div> */}
                            
                            {/* <div className='col-4'>
                                <CFormLabel ><b>Min. No. of Players</b></CFormLabel>
                                <CFormControl min="1" type="number" id="min_player" placeholder="Minimum Number of Players" />
                            </div> */}
                            {/* <div className='col-4'>
                        ...
                        <div className="row mb-3">
                            ...
                            <CButton id='save-button'    color="success" onClick={edit_battle} >Edit Battle</CButton>
                            </div>
                        </div>
                        <div className="row mb-3">
                            <div className="d-grid gap-2 d-md-block">
                            <CButton id='save-button'  style={{float:'right'}} color="success"  onClick={copy_battle} >Copy Battle</CButton> 
                            </div>
                        </div>
