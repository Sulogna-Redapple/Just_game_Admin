...
import DataTableGames from '../componets/DataTableGames'
    ...
    <>
      ...
      <CTabContent>
        <CTabPane visible={activeKey === 1}>
          <DataTableGames props={present_data}/>

        </CTabPane>
        <CTabPane visible={activeKey === 2}>
        <DataTableGames props={past_data}/>
