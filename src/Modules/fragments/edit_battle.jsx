                    ...
                    <form id='league-add-form'>
                       ...
                       <div className="row mb-3">
                        ...
                        <div className="row mb-3">
                            ...
                            <CButton id='save-button'   color="danger" >Cancel Battle</CButton>
                            </div>
                        </div>
                        <div className="row mb-3">
                            <div className="d-grid gap-2 d-md-block">
                            <CButton id='save-button' style={{float:'right'}}  color="success" >Save Battle</CButton> 
                            </div>
                        </div>
